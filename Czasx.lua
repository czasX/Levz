...
if makefolder and isfolder and writefile and isfile then
	pcall(function() -- good executor trust
		...
		if IsOnMobile then writefile("czasx/res/.nomedia", "") end
	end)
end

currentVersion = "2.4.1-cz"
...
Holder.Active = true
Holder.BackgroundColor3 = Color3.fromRGB(12, 14, 20)
Holder.BorderSizePixel = 0
Holder.Position = UDim2.new(0, 18, 1, -275)
...
Title.Text = "  Czasx  ·  " .. currentVersion
...
ModeBtn.Name = randomString()
ModeBtn.Parent = Holder
ModeBtn.BackgroundColor3 = Color3.fromRGB(20, 28, 38)
ModeBtn.BorderSizePixel = 0
ModeBtn.Position = UDim2.new(0, 222, 0, 30)
ModeBtn.Size = UDim2.new(0, 50, 0, 22)
ModeBtn.Font = Enum.Font.GothamBold
ModeBtn.TextSize = 10
ModeBtn.Text = "EXEC"
ModeBtn.TextColor3 = Color3.fromRGB(80, 220, 200)
ModeBtn.ZIndex = 12
...
function syncModeVisual()
	local stroke = ModeBtn:FindFirstChild("Stroke")
	if CZ_MODE then
		ModeBtn.Text = "FIND"
		ModeBtn.BackgroundColor3 = Color3.fromRGB(28, 18, 48)
		ModeBtn.TextColor3 = Color3.fromRGB(200, 160, 255)
		if stroke then stroke.Color = Color3.fromRGB(140, 90, 220) end
		Cmdbar.PlaceholderText = "search..."
		Cmdbar.PlaceholderColor3 = Color3.fromRGB(130, 110, 180)
	else
		ModeBtn.Text = "EXEC"
		ModeBtn.BackgroundColor3 = Color3.fromRGB(20, 28, 38)
		ModeBtn.TextColor3 = Color3.fromRGB(80, 220, 200)
		if stroke then stroke.Color = Color3.fromRGB(40, 160, 150) end
		Cmdbar.PlaceholderText = "type command..."
		Cmdbar.PlaceholderColor3 = Color3.fromRGB(90, 100, 130)
	end
	_G.CZ_SEARCH = CZ_MODE
end
...
ModeBtn.MouseButton1Click:Connect(function()
	...
	syncModeVisual()
	Cmdbar.Text = ""
	pcall(function() IndexContents('', true, false, true) end)
end)
ModeBtn.MouseEnter:Connect(function()
	TweenService:Create(ModeBtn, TweenInfo.new(0.12), {
		BackgroundColor3 = CZ_MODE and Color3.fromRGB(40, 25, 70) or Color3.fromRGB(28, 40, 52)
	}):Play()
end)
ModeBtn.MouseLeave:Connect(function()
	TweenService:Create(ModeBtn, TweenInfo.new(0.12), {
		BackgroundColor3 = CZ_MODE and Color3.fromRGB(28, 18, 48) or Color3.fromRGB(20, 28, 38)
	}):Play()
end)
...
Cmdbar.BackgroundColor3 = Color3.fromRGB(18, 22, 32)
Cmdbar.BackgroundTransparency = 0.15
Cmdbar.BorderSizePixel = 0
Cmdbar.Position = UDim2.new(0, 8, 0, 30)
Cmdbar.Size = UDim2.new(0, 210, 0, 22)
Cmdbar.Font = Enum.Font.Gotham
Cmdbar.TextSize = 13
Cmdbar.TextXAlignment = Enum.TextXAlignment.Left
Cmdbar.TextColor3 = Color3.fromRGB(220, 230, 255)
Cmdbar.Text = ""
Cmdbar.ZIndex = 10
Cmdbar.PlaceholderText = "type command..."
Cmdbar.PlaceholderColor3 = Color3.fromRGB(90, 100, 130)
...
CMDsF.Name = randomString()
CMDsF.Parent = Holder
CMDsF.BackgroundTransparency = 1
CMDsF.BorderSizePixel = 0
CMDsF.Position = UDim2.new(0, 6, 0, 56)
CMDsF.Size = UDim2.new(0, 268, 0, 200)
CMDsF.ScrollBarImageColor3 = Color3.fromRGB(40, 180, 170)
...
CMDsF.ZIndex = 10
CMDsF.ScrollBarImageTransparency = 0.35
...
SettingsButton.Position = UDim2.new(0, 254, 0, 4)
SettingsButton.Size = UDim2.new(0, 22, 0, 22)
SettingsButton.Image = getcustomasset("czasx/res/settings.png")
...
ReferenceButton.Position = UDim2.new(0, 230, 0, 5)
ReferenceButton.Size = UDim2.new(0, 16, 0, 16)
ReferenceButton.Image = getcustomasset("czasx/res/reference.png")
ReferenceButton.ZIndex = 10

Settings.Name = "Settings"
Settings.Parent = Holder
Settings.Active = true
Settings.BackgroundColor3 = Color3.fromRGB(10, 12, 18)
Settings.BorderSizePixel = 0
Settings.Position = UDim2.new(0, 0, 0, 260)
Settings.Size = UDim2.new(0, 280, 0, 204)
Settings.ZIndex = 10
...
ColorsButton = makeSettingsButton("Appearance",getcustomasset("czasx/res/edittheme.png"))
ColorsButton.Position = UDim2.new(0, 5, 0, 55)
ColorsButton.Size = UDim2.new(1, -10, 0, 25)
ColorsButton.Name = "Colors"
ColorsButton.Parent = SettingsHolder

Keybinds = makeSettingsButton("Hotkeys",getcustomasset("czasx/res/editkeybinds.png"))
Keybinds.Position = UDim2.new(0, 5, 0, 85)
Keybinds.Size = UDim2.new(1, -10, 0, 25)
Keybinds.Name = "Keybinds"
Keybinds.Parent = SettingsHolder

Aliases = makeSettingsButton("Aliases",getcustomasset("czasx/res/editaliases.png"))
...
Positions = makeSettingsButton("Waypoints",getcustomasset("czasx/res/editwaypoints.png"))
Positions.Position = UDim2.new(0, 5, 0, 145)
Positions.Size = UDim2.new(1, -10, 0, 25)
Positions.Name = "Waypoints"
Positions.Parent = SettingsHolder

EventBind = makeSettingsButton("Events",getcustomasset("czasx/res/bindsandplugins.png"),759)
EventBind.Position = UDim2.new(0, 5, 0, 205)
EventBind.Size = UDim2.new(1, -10, 0, 25)
EventBind.Name = "EventBinds"
EventBind.Parent = SettingsHolder

Plugins = makeSettingsButton("Plugins",getcustomasset("czasx/res/bindsandplugins.png"),743)
...
CloseImage.Image = getcustomasset("czasx/res/close.png")
...
PinImage.ZIndex = 10
PinImage.Image = getcustomasset("czasx/res/pin.png")
...
Logo.Image = getcustomasset("czasx/res/logo.png")
...
ExitImage_2.Image = getcustomasset("czasx/res/close.png")
...
Img.Image = getcustomasset("czasx/res/imgstudiopluginlogo.png")
Img.ZIndex = 10
...
ExitImage_3.Image = getcustomasset("czasx/res/close.png")
...
ExitImage_5.Image = getcustomasset("czasx/res/close.png")
...
ImageLabel.Image = getcustomasset("czasx/res/minimize.png")
...
ImageLabel_2.Image = getcustomasset("czasx/res/close.png")
...
eventEditor = (function()
	...
	local main = create({
		...
		{5,"ImageLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Image=getcustomasset("czasx/res/close.png"),Parent={4},Position=UDim2.new(0,5,0,5),Size=UDim2.new(0,10,0,10),ZIndex=10,}},
		...
		{53,"ImageLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Image=getcustomasset("czasx/res/settings.png"),Parent={52},Position=UDim2.new(0,2,0,2),Size=UDim2.new(0,16,0,16),ZIndex=10,}},
	})
	main.Name = randomString()
...
function createPopup(title, text)
	...
	ExitImage.Image = getcustomasset("czasx/res/close.png")
	ExitImage.ZIndex = 10
...
function maximizeHolder()
	if StayOpen == false then
		Holder:TweenPosition(UDim2.new(0, Holder.Position.X.Offset, 1, -275), "InOut", "Quart", 0.2, true, nil)
	end
end
...
function minimizeHolder()
	if StayOpen == false then
		Holder:TweenPosition(UDim2.new(0, Holder.Position.X.Offset, 1, minimizeNum), "InOut", "Quart", 0.5, true, nil)
	end
end
...
ColorsButton.MouseButton1Click:Connect(function()
	...
	if not colorpickerOpen then
		...
		Npicker.Default = function(self)
			updateColors(Color3.fromRGB(10, 12, 18),shade1)
			updateColors(Color3.fromRGB(14, 16, 22),shade2)
			updateColors(Color3.fromRGB(35, 150, 140),shade3)
			updateColors(Color3.new(1, 1, 1),text1)
			updateColors(Color3.new(0, 0, 0),text2)
			updateColors(Color3.fromRGB(35, 150, 140),scroll)
			wait()
			updatesaves()
		end
	else
...
SettingsButton.MouseButton1Click:Connect(function()
	if SettingsOpen == false then SettingsOpen = true
		Settings:TweenPosition(UDim2.new(0, 0, 0, 56), "InOut", "Quart", 0.5, true, nil)
		CMDsF.Visible = false
	else SettingsOpen = false
		CMDsF.Visible = true
		Settings:TweenPosition(UDim2.new(0, 0, 0, 260), "InOut", "Quart", 0.5, true, nil)
	end
end)
...
PrefixBox:GetPropertyChangedSignal("Text"):Connect(function()
	...
	Cmdbar.PlaceholderText = (CZ_MODE and "search..." or ("cmd · "..prefix))
	updatesaves()
end)
		...
		local function Index()
			if chatbox.Text:lower():sub(1,1) == prefix then
				if SettingsOpen == true then
					wait(0.2)
					CMDsF.Visible = true
					Settings:TweenPosition(UDim2.new(0, 0, 0, 260), "InOut", "Quart", 0.2, true, nil)
				end
				...
				if SettingsOpen == true then
					wait(0.2)
					Settings:TweenPosition(UDim2.new(0, 0, 0, 56), "InOut", "Quart", 0.2, true, nil)
					CMDsF.Visible = false
				end
			end
		end
...
Cmdbar.FocusLost:Connect(function(enterpressed)
	if enterpressed then
		if CZ_MODE or _G.CZ_SEARCH then
			if topCommand then pcall(autoComplete, topCommand) end
		else
...
addcmd('keepiy', {}, function(args, speaker)
	if queueteleport then
		KeepInfYield = true
		notify('PersistCZ','Czasx will now run after you teleport')
		updatesaves()
	else
...
addcmd('unkeepiy', {}, function(args, speaker)
	if queueteleport then
		KeepInfYield = false
		notify('PersistCZ','Czasx will no longer run after you teleport')
		updatesaves()
	else
		notify('Incompatible Exploit','Your exploit does not support this command (missing queue_on_teleport)')
	end
...
task.spawn(function()
	...
	if success then
		if currentVersion ~= latestVersionInfo.Version then
			notify("Czasx", "Running build " .. currentVersion)
		end
